...
const CompletedOrdersComponent: React.FC = () => {
  ...
  return (
    <div className="w-full mx-auto p-0 bg-gray-50 min-h-screen">
      {/* Completed Orders Grid - Responsive columns */}
      {orders.length > 0 ? (
          ...
          {orders.map((order) => (
            ...
            >
              ...
              <div className="p-3 sm:p-4 lg:p-5 pt-2">
                ...
                {/* Status Badge */}
                <div className="mb-3">
                  <span className="inline-block px-2.5 sm:px-3 py-1 bg-[#cef8de] text-[#0DA246] text-xs font-semibold rounded-full">
                    Completed
                  </span>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg sm:rounded-xl p-8 sm:p-12 text-center border border-gray-200">
          ...
          <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2">No completed orders</h3>
          <p className="text-sm sm:text-base text-gray-500">Completed orders will appear here</p>
        </div>
      )}
    </div>
  );
