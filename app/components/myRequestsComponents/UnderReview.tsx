            ...
            <div className="p-5">
              ...
              <div className="mb-2 mt-2">
                <span className="flex justify-between text-[10px] border-t border-gray-300 py-1 text-black">
                  ...
                  <div className=" text-[#FE7A36] text-[10px]">{order.status}</div>
                </span>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 px-4 border-2 bg-[#3652AD] font-semibold rounded-full transition-colors duration-200 text-[10px]"
                >
                  Edit
                </button>
